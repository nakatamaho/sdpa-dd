...
class Jal {
  public:
    static dd_real trace(DenseLinearSpace &aMat);
    ...
    static dd_real getMinEigen(DenseLinearSpace &lMat, DenseLinearSpace &xMat, WorkVariables &work);

    // calculate the minimum eigen value of xMat by QR method.
    static dd_real getMinEigen(DenseLinearSpace &xMat, WorkVariables &work);
    ...
    static bool multiply(DenseLinearSpace &retMat, DenseLinearSpace &aMat, DenseLinearSpace &bMat, dd_real *scalar = NULL);
#if 0
